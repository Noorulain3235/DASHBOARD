    ...
    <div className="min-h-screen p-4 md:p-6 lg:p-8">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold mb-2">Patients</h1>
        ...
        >
          ...
          <div className="p-6 border-b border-white/10">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
              <div>
                <h2 className="text-xl font-semibold mb-1">Patients List</h2>
            ...
            <table className="w-full">
              <thead className="hidden lg:table-header-group">
                <tr className="border-b border-white/10">
                  ...
                  <th className="text-left py-4 px-6 font-medium opacity-70">Last Visit</th>
                  <th className="text-left py-4 px-6 font-medium opacity-70">Condition</th>
