...
const AddAppointment = () => {
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      ...
      >
        <h1 className="text-3xl font-bold mb-1">Add Appointment</h1>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select className="w-full border rounded-lg p-2 focus:outline-none">
                  <option className="bg-gray-600">Select appointment type</option>
                  <option className="bg-gray-600">Consultation</option>
                  <option className="bg-gray-600">Follow-up</option>
                  <option className="bg-gray-600">Emergency</option>
                </select>
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <label className="flex items-center gap-2">
                ...
                <span>Tentative (Pending Confirmation)</span>
              </label>
              <label className="flex items-center gap-2">
                <input type="radio" name="status" />
