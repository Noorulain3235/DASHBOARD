...
const patients = [
  {
    ...
    Condition: "Lisinopril 10mg (Once daily)Metformin 500mg (Twice daily)",
  ...
  },
  {
    ...
    Condition: "Hydrochlorothiazide 25mg (Once daily)Ibuprofen 600mg (As needed)",
  ...
  },
  {
    ...
    Condition: "Amoxicillin 500mg (Three times daily)",
  ...
  },
  {
    ...
    Condition: "Prednisone 5mg (Once daily)Albuterol 90mcg (As needed)",
  ...
  },
  {
    ...
    Condition: "Atorvastatin 20mg (Once daily)",
    Doctor: "Dr. James Wilson",
  ...
  },
  {
    ...
    Condition: "Sertraline 50mg (Once daily)",
    Doctor: "Dr. Michael Chen",
    ...
    <div className="min-h-screen p-4 md:p-6 lg:p-8">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold mb-2">Medicine Templates</h1>
        ...
        >
          ...
          <div className="p-6 border-b border-white/10">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
              <div>
                <h2 className="text-xl font-semibold mb-1">All Templates</h2>
            ...
            <table className="w-full">
              <thead className="hidden lg:table-header-group">
                <tr className="border-b border-white/10">
                  ...
                  <th className="text-left py-4 px-6 font-medium opacity-70">Date</th>
                  <th className="text-left py-4 px-6 font-medium opacity-70">Medications</th>
                  <th className="text-left py-4 px-6 font-medium opacity-70">Doctor</th>
